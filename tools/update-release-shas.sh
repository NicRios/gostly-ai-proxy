...
# Formula/gostly.rb and scoop/gostly.json.
#
...
#   3. Patches the `hash` field in scoop/gostly.json.
...
# ── Patch scoop/gostly.json ─────────────────────────────────────────────────
SCOOP="$ROOT/scoop/gostly.json"
echo "Patching $SCOOP ..."
...
echo "  git diff Formula/gostly.rb scoop/gostly.json"
